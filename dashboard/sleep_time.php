...
<form method="POST" action="insert.php">
      ...
      <p>Enter Date:&nbsp;<input type="date" min="2000-01-01" max="2058-12-31" name="sleep_time_date"></p>
      <p>Enter The Sleep Duration in hours(INT):&nbsp;<input type="number" required name="sleep_time"></p>
