...
<form method="POST" action="insert.php">
      ...
      <p>Enter Date:&nbsp;<input type="date" min="2000-01-01" max="2058-12-31" name="out_temp_date"></p>
      <p>Enter Outdoor Temperature in Celsius:&nbsp;<input type="number" required name="out_temp"></p>
