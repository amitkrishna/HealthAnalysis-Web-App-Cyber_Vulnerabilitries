    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="no_steps.php">
...
<form method="POST" action="insert.php">
      ...
      <p>Enter Date:&nbsp;<input type="date" min="2000-01-01" max="2058-12-31" name="no_of_naps_date"></p>
      <p>Enter Number_of_Naps:&nbsp;<input type="number" required name="no_of_naps"></p>
...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
      <script>window.jQuery || document.write('<script src="/docs/4.3/assets/js/vendor/jquery-slim.min.js"><\/script>')</script><script src="/docs/4.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-xrRywqdh3PHs8keKZN+8zzc5TX0GRTLCcmivcbNJWm2rs5C8PRhcEn3czEjhAO9o" crossorigin="anonymous"></script>
       ...
       <script type="text/javascript" src="sleep_time.js"></script>
