...
session_start();
$usr=$_SESSION["user"];
$result = mysqli_query($conn,"SELECT * FROM Project_Number_of_Steps WHERE username='{$usr}'");
...
<form method="POST" action="insert.php">
      ...
      <p>Enter Date:&nbsp;<input type="date" min="2000-01-01" max="2058-12-31" name="no_of_steps_date"></p>
      <p>Enter Number_of_steps:&nbsp;<input type="number" required name="no_of_steps"></p>
...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
      <script>window.jQuery || document.write('<script src="/docs/4.3/assets/js/vendor/jquery-slim.min.js"><\/script>')</script><script src="/docs/4.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-xrRywqdh3PHs8keKZN+8zzc5TX0GRTLCcmivcbNJWm2rs5C8PRhcEn3czEjhAO9o" crossorigin="anonymous"></script>
       ...
       <script type="text/javascript" src="no_of_steps_app.js"></script>
