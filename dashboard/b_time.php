...
session_start();
$usr=$_SESSION["user"];
$_SESSION["table"]="Project_Bed_time";
...
<form method="POST" action="insert.php">
      ...
      <p>Enter Date:&nbsp;<input type="date" min="2000-01-01" max="2058-12-31" name="b_time_date"></p>
      <p>Enter Bed Time:&nbsp;<input type="time" required name="bed_time"></p>
